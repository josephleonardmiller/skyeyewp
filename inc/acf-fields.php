...
function skyeye_register_acf_fields() {
    ...
    acf_add_local_field_group( [
        ...
        'fields' => [
            ...
            [
                'key'          => 'field_portfolio_teaser_url',
                'label'        => 'Teaser Film URL',
                'name'         => 'teaser_url',
                'type'         => 'url',
                'instructions' => 'Vimeo URL for a teaser/short cut. When set, replaces the last two gallery images with a teaser player.',
            ],
            [
                'key'           => 'field_portfolio_teaser_thumbnail',
                'label'         => 'Teaser Thumbnail',
                'name'          => 'teaser_thumbnail',
                'type'          => 'image',
                'return_format' => 'array',
                'preview_size'  => 'medium',
                'instructions'  => 'Poster image for the teaser player. Defaults to the main video thumbnail if left blank.',
            ],
        ],
    ...
    acf_add_local_field_group( [
        ...
        'fields' => [
            ...
            [
                'key'          => 'field_about_testimonial_post',
                'label'        => 'Gallery — Testimonial (Portfolio Post)',
                'name'         => 'about_testimonial_post',
                'type'         => 'post_object',
                'post_type'    => [ 'portfolio' ],
                'allow_null'   => 1,
                'multiple'     => 0,
                'return_format' => 'object',
                'ui'           => 1,
                'instructions' => 'Pick a portfolio post to pull its quote & attribution into the gallery. Or leave blank and fill the fields below.',
            ],
            [ 'key' => 'field_about_quote',      'label' => 'Gallery — Quote (override)', 'name' => 'about_quote',      'type' => 'textarea', 'rows' => 3, 'instructions' => 'Used only if no portfolio post is selected above.' ],
            [ 'key' => 'field_about_quote_attr', 'label' => 'Gallery — Attribution',      'name' => 'about_quote_attribution', 'type' => 'text', 'instructions' => 'e.g. Alwyn & Paul' ],
